...
//---------------------------------------------------------------------------
uses
  Graphics, Types, Vectors2, Matrices3, AsphyreColors, AsphyreTypes, AbstractTextures;
...
一般用于中、低档显卡中。
    ...
    procedure Draw(X, Y: Integer; SrcRect: TRect; Texture: TAsphyreCustomTexture; Transparent: Boolean = True); overload; virtual;
    procedure Draw(X, Y: Integer; Texture: TAsphyreCustomTexture; Transparent: Boolean = True); overload; virtual;
    procedure Draw(X, Y: Integer; SrcRect: TRect; Texture: TAsphyreCustomTexture; Effect: TDrawingEffect = deNormal); overload; virtual;
...
procedure TAsphyreCanvas.Draw(Texture: TAsphyreCustomTexture; x, y: Integer; Effect: TDrawingEffect);
var
...
begin
  ...
  begin
    ...
    Mapping[0].x := ViewPos.x / Texture.MemoryWidth;
    Mapping[0].y := ViewPos.y / Texture.MemoryHeight;
