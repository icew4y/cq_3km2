...
interface
uses Types, Classes, Controls, Math, Graphics, AbstractCanvas, AbstractTextures, AspDWinCtl, AspWIL;
type
  TAspDScrollBar = class(TAspDControl)
  private
    FItemHeight: Integer;
    FItemIndex: Integer;
...
procedure Register;
begin
   RegisterComponents('AspMirGame', [TAspDScrollBar]);
end;

{ TAspDScrollBar }

procedure TAspDScrollBar.BarImageIndexChange(Sender: TObject);
var
...
constructor TAspDScrollBar.Create(AOwner: TComponent);
begin
...
destructor TAspDScrollBar.Destroy;
begin
...
procedure TAspDScrollBar.DirectPaint(dsurface: TAsphyreCanvas);
var
  d: TAsphyreLockableTexture;
  Rc:TRect;
  nIndex: Integer;
...
procedure TAspDScrollBar.DoResize(var NewRect: TRect);
begin
  inherited;
...
procedure TAspDScrollBar.First;
var
  P: Integer;
  nHeight: Integer;
  nMaxValue: Integer;
...
function TAspDScrollBar.InBarRange(X, Y: Integer): Boolean;
var
  nHeight: Integer;
  nMaxValue: Integer;
  nBarTop: Integer;
...
function TAspDScrollBar.InNextRange(X, Y: Integer): Boolean;
begin
  Result := (X >= GLeft) and (Y >= GTop + (GHeight - FNextImageSize));
end;

function TAspDScrollBar.InPrevRange(X, Y: Integer): Boolean;
begin
  Result := (X >= GLeft) and (Y <= GTop + FPrevImageSize);
end;

procedure TAspDScrollBar.Last;
var
  P: Integer;
  nHeight: Integer;
  nMaxValue: Integer;
...
function TAspDScrollBar.MouseDown(Button: TMouseButton; Shift: TShiftState; X,
  Y: Integer): Boolean;
var
  nHeight: Integer;
  nMaxValue: Integer;
...
function TAspDScrollBar.MouseMove(Shift: TShiftState; X, Y: Integer): Boolean;
var
  nHeight: Integer;
  nMaxValue: Integer;
  nBarTop: Integer;
...
function TAspDScrollBar.MouseUp(Button: TMouseButton; Shift: TShiftState; X,
  Y: Integer): Boolean;
begin
...
procedure TAspDScrollBar.NextImageIndexChange(Sender: TObject);
var
  D: TAsphyreLockableTexture;
  nIndex: Integer;
begin
...
procedure TAspDScrollBar.PrevImageIndexChange(Sender: TObject);
var
  D: TAsphyreLockableTexture;
  nIndex: Integer;
begin
...
procedure TAspDScrollBar.Previous;
var
  P: Integer;
  nHeight: Integer;
  nMaxValue: Integer;
...
procedure TAspDScrollBar.SetItemHeight(Value: Integer);
begin
  FItemHeight := Max(Value, Canvas.TextHeight('Pp'));
end;

procedure TAspDScrollBar.SetItemIndex(Value: Integer);
var
  nItemCount: Integer;
begin
...
procedure TAspDScrollBar.SetMaxValue(const Value: Integer);
var
...
procedure TAspDScrollBar.SetPosition(const Value: Integer);
var
  P, nMaxValue, nHeight: Integer;
begin
...
procedure TAspDScrollBar.SetRemoveSize(const Value: Integer);
var
  P, nMaxValue, nHeight: Integer;
begin
...
procedure TAspDScrollBar.SetScrollSize(const Value: Integer);
begin
