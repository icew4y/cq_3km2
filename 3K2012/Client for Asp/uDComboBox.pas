...
interface
uses DWinCtl, Classes, Graphics, uDPopupMenu, AbstractCanvas, AbstractTextures,
     AsphyreTextureFonts,Controls, Math, Windows;
...
begin
  ...
  //if not (csDesigning in ComponentState) then begin
    ...
    AspTextureFonts.SetFont('宋体', Font.Size);
    ...
    AspTextureFonts.SetFont('宋体', OldSize);
  end;
end;
...
procedure TDCombobox.DirectPaint(dsurface: TAsphyreCanvas);
var
  I, nX: Integer;
