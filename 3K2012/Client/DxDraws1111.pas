...
uses
  ...
  DXClass, DIB, DXTexImg, DirectX, Share;
...
//新加
  ...
  public
    ...
    procedure BoldTextOut(x, y, fcolor, bcolor: Integer; str:string);
    ...
    procedure DrawWaveXSub(X, Y, Width, Height: Integer; const SrcRect: TRect;
      Source: TDirectDrawSurface; Transparent: Boolean; amp, Len, ph: Integer;
      Alpha: Integer = 255);
    procedure FastDrawAlpha(const Dest, Src: TRect; Source: TDirectDrawSurface; TRANSPARENT: Boolean = True);
    procedure Fill(DevColor: TColor{Longint});
...
procedure TDirectDrawSurface.Fill(DevColor: TColor{Longint});
var
  DBltEx: TDDBltFX;
begin
...
begin
  ...
  {  Surface making  }
  FDXDraw.FPrimary := TDirectDrawSurface.Create(FDXDraw.FDDraw);  //不是这的问题
...
begin
  ...
  begin
    ...
    if (Parent <> nil) and (Initialized) and (Surface.SurfaceDesc.ddsCaps.dwCaps and DDSCAPS_VIDEOMEMORY <> 0) then begin
      Parent.Invalidate;
    end;
  end;
end;
