...
uses
  Windows, Classes, Graphics, Math, MapUnit;
...
{  TMapHeader = packed record //20110428 注释，直接引用MapUnit单元声明
    wWidth: Word;
    wHeight: Word;
    sTitle: string[16];
  ...
  private
    FPath: TPath;
    //MapHeader: TMapHeader;//20110428 注释
  public
    //MapData: TMapData;
    Title: string;
    BeginX, BeginY, EndX, EndY: Integer;
    //MapData: TMapInfoArray;//20110428 注释
    constructor Create;
