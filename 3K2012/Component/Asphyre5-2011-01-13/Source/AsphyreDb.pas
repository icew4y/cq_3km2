unit AsphyreDb;
//---------------------------------------------------------------------------
// AsphyreDb.pas                                        Modified: 08-Sep-2008
// Asphyre Secure Database (ASDb) implementation                 Version 1.12
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
 Windows, Classes, Math, SysUtils, StreamUtils, AsphyreData, AsphyreMD5,
 AsphyreXTEA;
...
//---------------------------------------------------------------------------
function TASDb.WriteString(const Key, Text: string; RecType: Integer): Boolean;
begin
