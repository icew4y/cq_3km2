...
// Remove "dots" below to enable some kind of dynamic linking
 ...
 *)
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3D8> _di_IDirect3D8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DDevice8> _di_IDirect3DDevice8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DSwapChain8> _di_IDirect3DSwapChain8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DResource8> _di_IDirect3DResource8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DBaseTexture8> _di_IDirect3DBaseTexture8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DTexture8> _di_IDirect3DTexture8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DVolumeTexture8> _di_IDirect3DVolumeTexture8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DCubeTexture8> _di_IDirect3DCubeTexture8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DVertexBuffer8> _di_IDirect3DVertexBuffer8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DIndexBuffer8> _di_IDirect3DIndexBuffer8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DSurface8> _di_IDirect3DSurface8;'}
  ...
  {$HPPEMIT 'typedef System::DelphiInterface<IDirect3DVolume8> _di_IDirect3DVolume8;'}
...
begin
  ...
  if (not Result) and DirectDllFileExist(Direct3D8dll) then
  begin
