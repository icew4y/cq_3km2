unit Vectors2;
//---------------------------------------------------------------------------
// Vectors2.pas                                         Modified: 31-Oct-2007
// Definitions and functions working with 2D vectors             Version 1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
{$IFDEF VER185}
function Vectors2Add(const a, b: TPoint2): TPoint2;
function Vectors2Subtract(const a, b: TPoint2): TPoint2;
function Vectors2Multiply(const a, b: TPoint2): TPoint2; overload;
function Vectors2Divide(const a, b: TPoint2): TPoint2;  overload;

function Vectors2Negative(const v: TPoint2): TPoint2;
function Vectors2Multiply(const v: TPoint2; k: Single): TPoint2;  overload;
function Vectors2Multiply(const v: TPoint2; k: Integer): TPoint2;  overload;
function Vectors2Divide(const v: TPoint2; k: Single): TPoint2;  overload;
function Vectors2Divide(const v: TPoint2; k: Integer): TPoint2;  overload;

function PointToPoint2(const Point: TPoint): TPoint2;
function Point2ToPoint(const Point: TPoint2): TPoint;

function Point2pxToPoint2(const Point: TPoint2px): TPoint2;
function Point2ToPoint2px(const Point: TPoint2): TPoint2px;
...
function Vectors2Multiply(const a, b: TPoint2): TPoint2;
begin
 Result.x:= a.x * b.x;
 Result.y:= a.y * b.y;
end;
...
function Vectors2Divide(const a, b: TPoint2): TPoint2;
begin
 Result.x:= a.x / b.x;
 Result.y:= a.y / b.y;
end;
...
function Vectors2Multiply(const v: TPoint2; k: Single): TPoint2;
begin
 Result.x:= v.x * k;
 Result.y:= v.y * k;
end;
...
function Vectors2Multiply(const v: TPoint2; k: Integer): TPoint2;
begin
 Result.x:= v.x * k;
 Result.y:= v.y * k;
end;
...
function Vectors2Divide(const v: TPoint2; k: Single): TPoint2;
begin
 Result.x:= v.x / k;
 Result.y:= v.y / k;
end;
...
function Vectors2Divide(const v: TPoint2; k: Integer): TPoint2;
begin
 Result.x:= v.x / k;
 Result.y:= v.y / k;
end;
