...
private:
	...
	Extended __fastcall GetDisplayValue(void);
	...
	void __fastcall SetDisplayValue(const Extended Value);
...
public:
	...
	__property Extended DisplayValue = {read=GetDisplayValue, write=SetDisplayValue};
