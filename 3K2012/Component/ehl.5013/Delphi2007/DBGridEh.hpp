...
protected:
	...
	virtual void __fastcall InternalSetExpressionStr(const AnsiString Value);
...
private:
	...
	void __fastcall PaintInplaceButton(TColumnEh* Column, Graphics::TCanvas* Canvas, Toolctrlseh::TEditButtonStyleEh ButtonStyle, const Types::TRect &Rect, const Types::TRect &ClipRect, int DownButton, bool Active, bool Flat, bool Enabled, Graphics::TColor ParentColor, Graphics::TBitmap* Bitmap, Byte TransparencyPercent);
	void __fastcall SetRowPanel(const bool Value);
...
protected:
	...
	virtual void __fastcall StopRowPanelTitleCellDrag(Classes::TShiftState Shift, int X, int Y);
...
public:
	...
	TColumnEh* __fastcall GetColumnInRowPanelAtPos(const Types::TPoint &InCellPos);
	...
	__property bool RowPanel = {read=FRowPanel, write=SetRowPanel, default=0};
