object frmConfigMerchant: TfrmConfigMerchant
  ...
  object GroupBoxScript: TGroupBox
    ...
    object GroupBox3: TGroupBox
      ...
      object CheckBoxArmsTear: TCheckBox
        Left = 232
        Top = 64
        Width = 79
        Height = 17
        Caption = #25286#21368#36196#28814#30707
        TabOrder = 11
        Visible = False
        OnClick = CheckBoxArmsTearClick
      end
      object CheckBoxArmsExchange: TCheckBox
        Left = 232
        Top = 80
        Width = 113
        Height = 17
        Caption = #27494#22120#20817#25442#21367#36724#30862#29255
        TabOrder = 12
        Visible = False
        OnClick = CheckBoxArmsExchangeClick
      end
    end
  ...
  object GroupBox1: TGroupBox
    ...
    Width = 371
    Height = 369
    Caption = 'NPC'#21015#34920'(Ctrl+F'#26597#25214'):'
    TabOrder = 6
