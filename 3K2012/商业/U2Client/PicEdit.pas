...
uses TypInfo, SysUtils, DesignConst;
...
begin
  ...
  begin
    ...
    if Filters = FTAll then
      Filter := GraphicFilter(GraphicClass)
    else Filter := GraphicFilter(TGraphicClass(FPicture.Bitmap.ClassType));
  end;
