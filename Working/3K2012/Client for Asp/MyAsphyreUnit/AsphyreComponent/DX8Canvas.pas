...
//---------------------------------------------------------------------------
uses
  Windows, Direct3D8, D3DX8, AbstractCanvas, Vectors2, Matrices3,
...
//---------------------------------------------------------------------------
  ...
  private
    ...
    //增加麻痹效果支持By TasNat at: 2012-06-28 12:41:34 
...
const
   ShaderCode = 'ps.1.1'#13#10 +
    ...
    //'add r0.w, t0.z, r0.w'#13#10 +//打开这行颜色就正常了 但是不 能编译By TasNat at: 2012-06-26 22:38:10
    'mov r1.w, t0.w'#13#10 +
...
begin
  ...
  if (FPixelShaderHandle <> 0) then
      Device8.DeletePixelShader(FPixelShaderHandle);
  FPixelShaderHandle:= 0;


  if FPixelShaderBuf <> nil then
    Device8.CreatePixelShader(FPixelShaderBuf.GetBufferPointer,
                                            FPixelShaderHandle);
end;
...
begin
  //增加麻痹效果支持 By TasNat at: 2012-06-26 22:38:10
  if deGrayscale = Effect then begin
    with Device8 do
      begin
    ...
    Device8.SetPixelShader(FPixelShaderHandle);
  end else begin
    Device8.SetPixelShader(0);
  case Effect of
    deBlend:
      with Device8 do
      begin
