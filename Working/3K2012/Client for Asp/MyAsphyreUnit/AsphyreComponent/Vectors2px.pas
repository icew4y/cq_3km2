unit Vectors2px;
//---------------------------------------------------------------------------
// Vectors2px.pas                                       Modified: 31-Oct-2007
// Definitions and functions working with 2D integer vectors     Version 1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
{$IFDEF VER185}
function Vectors2pxAdd(const a, b: TPoint2px): TPoint2px;
function Vectors2pxSubtract(const a, b: TPoint2px): TPoint2px;
function Vectors2pxMultiply(const a, b: TPoint2px): TPoint2px; overload;
function Vectors2pxDivide(const a, b: TPoint2px): TPoint2px;   overload;

function Vectors2pxNegative(const v: TPoint2px): TPoint2px;
function Vectors2pxMultiply(const v: TPoint2px; k: Single): TPoint2px; overload;
function Vectors2pxMultiply(const v: TPoint2px; k: Integer): TPoint2px; overload;
function Vectors2pxDivide(const v: TPoint2px; k: Single): TPoint2px; overload;
function Vectors2pxDivide(const v: TPoint2px; k: Integer): TPoint2px; overload;

function Vectors2pxEqual(const a, b: TPoint2px): Boolean;
function Vectors2pxNotEqual(const a, b: TPoint2px): Boolean;

function PointToPoint2px(const v: TPoint): TPoint2px;
function Point2pxToPoint(const v: TPoint2px): TPoint;
{$ELSE}
//---------------------------------------------------------------------------
{$ifdef fpc}
...
function Vectors2pxMultiply(const a, b: TPoint2px): TPoint2px;
...
function Vectors2pxDivide(const a, b: TPoint2px): TPoint2px;
...
function Vectors2pxMultiply(const v: TPoint2px;
 k: Integer): TPoint2px;
...
function Vectors2pxDivide(const v: TPoint2px;
 k: Integer): TPoint2px;
...
begin
 ...
 {$IFDEF VER185}
   if Vectors2pxEqual(Data[i], Point) then
 {$ELSE}
