...
interface
uses Types, DWinCtl, Classes, Graphics, AbstractCanvas, AbstractTextures, uDScrollBar, Controls, Math;
type
...
procedure TDScrollBox.DirectPaint(dsurface: TAsphyreCanvas);
var
  I: Integer;
  rc: TRect;
...
begin
  ...
  ClipRect := dsurface.ClipRect;
  dsurface.ClipRect := ClientRect;
