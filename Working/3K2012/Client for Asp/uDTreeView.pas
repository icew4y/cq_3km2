...
interface
uses Classes, Math, DWinCtl, uDControls, Controls, AbstractCanvas, AbstractTextures,
     AsphyreTextureFonts, uDScrollBar, Types, Graphics, Wil;
...
procedure TDTreeView.DirectPaint(dsurface: TAsphyreCanvas);
var
