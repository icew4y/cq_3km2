...
interface
uses
  Windows, Actor, AxeMon, MShare, DXDraws, WIL, Grobal2;
...
procedure TpjMon.DrawChr (dsurface: TDirectDrawSurface; dx, dy: integer; blend: Boolean;boFlag:Boolean);
begin
