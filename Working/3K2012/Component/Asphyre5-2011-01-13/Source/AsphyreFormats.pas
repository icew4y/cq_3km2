...
type
 ...
 public
  ...
  function Insert(Format: TAsphyrePixelFormat): Integer;
  function IndexOf(Format: TAsphyrePixelFormat): Integer;
  function Include(Format: TAsphyrePixelFormat): Integer;
  procedure Remove(Index: Integer);
  procedure Clear();
  procedure SortBestMatch(Format: TAsphyrePixelFormat);
  procedure InsertAll();
...
//---------------------------------------------------------------------------
function TAsphyreFormatList.Insert(Format: TAsphyrePixelFormat): Integer;
begin
 Result:= Length(Items);
...
//---------------------------------------------------------------------------
function TAsphyreFormatList.IndexOf(Format: TAsphyrePixelFormat): Integer;
var
 i: Integer;
begin
 Result:= -1;
...
//---------------------------------------------------------------------------
function TAsphyreFormatList.Include(Format: TAsphyrePixelFormat): Integer;
begin
 Result:= IndexOf(Format);
 if (Result = -1) then Result:= Insert(Format);
end;
...
//---------------------------------------------------------------------------
procedure TAsphyreFormatList.SortBestMatch(Format: TAsphyrePixelFormat);
begin
 SortReqFormat:= Format;
