...
*    2006.08.10  added ZDecompressStrG (simple gzip format)                  *
...
*                                                                            *
*    2006.10.07  anders johansen                                             *
*      pointing out the ELibError constructor incompatibility with c++       *
*        builder                                                             *
*****************************************************************************}
...
{****************************************************************************}
{ Changes by Lifepower (lifepower@mail333.com):
  The following functions have been moved to public section to be used by
  third party packages that need them, e.g. TPNGImage.                       }
{****************************************************************************}
...
{** deflate routines ********************************************************}
{ Changes by Lifepower (lifepower@mail333.com):
  Some functions have been commented and moved to public section to be used
  by third party packages that need them, e.g. TPNGImage.                    }
{function deflateInit_(var strm: TZStreamRec; level: Integer; version: PChar;
  recsize: Integer): Integer;
  external;}
