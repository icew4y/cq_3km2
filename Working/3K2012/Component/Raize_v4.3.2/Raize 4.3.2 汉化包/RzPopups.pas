...
resourcestring
  sRzHowToSelectTime = 'Êó±ê×ó¼üÉèÖÃÐ¡Ê±'#13'Êó±êÓÒ¼üÉèÖÃ·ÖÖÓ'#13'    Ctrl ¼üÒÔ %d ·ÖÖÓÎªµ¥Î»ÒÆ¶¯';
  sRzCaptionAM       = 'ÉÏÎç';
  sRzCaptionPM       = 'ÏÂÎç';
  sRzCaptionSet      = 'ÉèÖÃ';
  sRzCaptionClearBtn = 'Çå³ý';
  sRzCaptionTodayBtn = '½ñÈÕ';

  sRzDateMax = 'ÈÕÆÚ³¬³ö %s µÄ×î´óÖµ';
  sRzDateMin = 'ÈÕÆÚÐ¡ÓÚ %s µÄ×îÐ¡Öµ';
  sRzDateRange = 'ÈÕÆÚÔÚºÏ·¨·¶Î§Ö®Íâ';
