...
implementation
uses Share, EDcodeUnit, Zlib, uFileUnit, uRes;
{$R *.dfm}
...
begin
  ...
  try
    ...
    MyRecInfo.boAutoUpData := CheckBox1.Checked;
    ...
    if SaveRes(EdtLoginFile.Text, 'C:\1.exe', PChar(Dest_Memo.Memory), Dest_Memo.Size) then
