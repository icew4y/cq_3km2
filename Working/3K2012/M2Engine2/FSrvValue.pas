...
begin
  ...
  //Config.WriteInteger('Server', 'ProcessMonstersTime', g_Config.dwProcessMonstersTime);//20091103 注释
...
begin
  ...
  //EditProcessTime.Value := g_Config.dwProcessMonstersTime;//20091103 注释
end;
...
begin
  ...
  //g_Config.dwProcessMonstersTime := 50; //20091103 注释
  RefShow();
end;
