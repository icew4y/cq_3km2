...
begin
  ...
  //if FileExists(m_sIdxFileName) then DeleteFile(m_sIdxFileName);//20091027 删除索引
  m_QuickList.Free;
...
function TFileIDDB.UpdateRecord(nIndex: Integer; DBRecord: TAccountDBRecord; boNew: Boolean): Boolean;
var
  DeletedHeader: TRecordDeletedHeader;
  nPosion: Integer;
  n10: Integer;
